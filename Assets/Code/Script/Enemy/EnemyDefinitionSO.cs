...
public class EnemyDefinitionSO : ScriptableObject
{
    ...
    [Title("Récompense")]
    [LabelText("Or lâché à la mort")]
    public int BaseGoldReward = 5;

    [LabelText("Scaling or par niveau")]
    [Tooltip("Multiplicateur exponentiel appliqué par niveau : Or = BaseGoldReward * scale^(niveau-1). N'a d'effet qu'avec un niveau > 1.")]
    public float GoldScalePerLevel = 1f;
